...
{
    public partial class ES_View : Form
    {
        public ES_View()
        {
            InitializeComponent();
        ...
        private void ES_View_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                this.CombinedTableTableAdapter.FillBy1(this.Employee_DBDataSet1.CombinedTable, ((int)(System.Convert.ChangeType(textBox1.Text, typeof(int)))));
                this.reportViewer1.RefreshReport();
            }
